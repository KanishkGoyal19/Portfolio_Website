...
export const projects = [
  ...
  {
    title: "Chef AI",
    description: "A React-based web application that generates personalized recipes using the Claude AI API. It features a dynamic interface and a responsive design powered by Tailwind CSS and Shadcn, ensuring a seamless user experience across devices.",
    tags: [{ name: "React", color: "text-blue-500" }, { name: "JavaScript", color: "text-yellow-500" }, { name: "API Integration", color: "text-orange-500" }, { name: "Tailwind CSS", color: "text-pink-500" },{ name: "Vercel", color: "text-purple-500" } ],
